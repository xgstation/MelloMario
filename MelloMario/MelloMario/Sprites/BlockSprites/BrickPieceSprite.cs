...
namespace MelloMario.Sprites.BlockSprites
{
    internal class BrickPieceSprite : BaseSprite
    {
        ...
        protected override void OnDraw(int time, SpriteBatch spriteBatch, Rectangle destination)
        {
            ...
            float k = 5f / Math.Abs(2f - Const.FORCE_F_AIR / 20f);
            //LB
            offsetX[0] = -elapsed / k + 4f;
            offsetY[0] = Const.FORCE_G * elapsed * elapsed / 16000f - elapsed + 16f;
            ...
            offsetY[1] = Const.FORCE_G * elapsed * elapsed / 14400f - elapsed + 32f;
            ...
            offsetY[2] = Const.FORCE_G * elapsed * elapsed / 16000f - elapsed + 16f;
            ...
            offsetY[3] = Const.FORCE_G * elapsed * elapsed / 14400f - elapsed + 32f;
            ...
            float rotation = elapsed * 30f / Const.FORCE_F_AIR;
