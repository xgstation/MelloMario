    ...
    class GameScript
    {
        ...
        public void Bind(IEnumerable<IController> controllers, IGameCharacter character, GameModel model, IMarioMovementState move)
        {
            ...
            foreach (IController controller in controllers)
            {
                ...
                controller.AddCommand(Keys.W, factory.CreateGameCharacterCommand("Jump", character, move), KeyBehavior.hold);
                controller.AddCommand(Keys.W, factory.CreateGameCharacterCommand("JumpPress", character, move), KeyBehavior.press);
                controller.AddCommand(Keys.W, factory.CreateGameCharacterCommand("JumpRelease", character, move), KeyBehavior.release);
